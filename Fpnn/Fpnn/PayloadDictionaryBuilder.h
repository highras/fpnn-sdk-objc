...
@property(nonatomic,strong)NSObject * tmpValue;
@property(nonatomic,assign)BOOL mainStart;
@property(nonatomic,assign)BOOL mainoOver;
@property(nonatomic,strong)PayloadDictionaryBuilder * father;
@property (assign, nonatomic) BOOL buildFinish;
